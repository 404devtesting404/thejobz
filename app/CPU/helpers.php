...
class Helpers
{
        ...
        if ($multi_data == true) {
            ...
            if (count($data['translations'])) {
                foreach ($data['translations'] as $translation) {
                    ...
                    if ($translation->key == 'description') {
                        $data['details'] = $translation->value;
                    }
                }
            }
        }
    ...
    public static function sales_commission($detail)
    {
        $seller = Seller::find($detail['seller_id']);
        ...
        $commission_amount = (($detail->price / 100) * $commission) * $detail->qty;
