                ...
                <ul class="sidebar-nav">
                    ...
                    @if (Auth::check() && Auth::user()->is_admin === 1)
                        <li class="sidebar-item">
                            ...
                            <ul id="jobs" class="sidebar-dropdown list-unstyled collapse "
                                data-bs-parent="#sidebar">
                                <li class="sidebar-item"><a class="sidebar-link"
                                ...
                                <li class="sidebar-item"><a class="sidebar-link"
                                        href="{{ route('admin.job.alljobs') }}">All
                                        jobs</a>
                                </li>
                                <li class="sidebar-item"><a class="sidebar-link"
                    ...
                    @if (Auth::check() && Auth::user()->is_admin === 1)
                        <li class="sidebar-item">
                            <a href="{{ route('admin.business-settings.web-config') }}" class="sidebar-link  ">
                                <i class="align-middle" data-feather="layout"></i> <span class="align-middle">Web
                                    config</span>
                            </a>
                        </li>
                    @endif
