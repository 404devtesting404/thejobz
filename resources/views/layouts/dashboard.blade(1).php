...
<head>
    ...
    <link rel="shortcut icon" href="{{ asset('resources/dashboard_assets/img/favicon.ico') }}">
    ...
    <link class="js-stylesheet" href="{{ asset('resources/dashboard_assets/css/light.css') }}" rel="stylesheet">
    ...
    {{-- <script src="{{ asset('resources/dashboard_assets/js/settings.js') }}"></script> --}}
    <!-- END SETTINGS -->
    <script>
...
<body data-theme="default" data-layout="fluid" data-sidebar-position="left" data-sidebar-behavior="sticky">
              ...
              c0.2,0.5,0,1.1-0.5,1.3l-9,4C10.3,20,10.1,20,10,20z" />
                ...
                <ul class="sidebar-nav">
                    ...
                    <li class="sidebar-item active">
                        {{-- <a href="{{ route('admin.home') }}" data-bs-target="#dashboards" data-bs-toggle="collapse" class="sidebar-link"> --}}
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="jobs" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                            <li class="sidebar-item"><a class="sidebar-link"
                                    href="{{ route('admin.job.list') }}">List</a>
                            </li>
                            <li class="sidebar-item"><a class="sidebar-link"
                                href="{{ route('admin.job.images') }}">Images</a>
                           </li>
                            <li class="sidebar-item"><a class="sidebar-link"
                            href="{{ route('admin.job.content_update') }}">Content Update</a>
                            </li>
                            <li class="sidebar-item"><a class="sidebar-link"
                            href="{{ route('admin.job.alljobs') }}">All jobs</a>
                           </li>
                            <li class="sidebar-item"><a class="sidebar-link"
                                href="{{ route('admin.job.console') }}">Console</a>
                           </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
                        ...
                        <ul id="jobs" class="sidebar-dropdown list-unstyled collapse " data-bs-parent="#sidebar">
                            <li class="sidebar-item"><a class="sidebar-link"
                                    href="{{ route('admin.contacts.list') }}">List</a>
                            </li>
                        </ul>
                    </li>
                    <li class="sidebar-item">
                        <a    href="{{ route('admin.adds.list') }}"  class="sidebar-link  ">
                            <i class="align-middle" data-feather="layout"></i> <span class="align-middle">Adds</span>
                        </a>
                    </li>

                    <li class="sidebar-item">
                        <a    href="{{ route('admin.business-settings.web-config') }}"  class="sidebar-link  ">
                            <i class="align-middle" data-feather="layout"></i> <span class="align-middle">Web config</span>
                        </a>
                    </li>
                    {{-- <li class="sidebar-item">
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="form-plugins" class="sidebar-dropdown list-unstyled collapse "
                            data-bs-parent="#sidebar">
                            <li class="sidebar-item"><a class="sidebar-link"
                                    href="forms-advanced-inputs.html">Advanced
                                    Inputs</a></li>
                    ...
                    <li class="sidebar-item">
                        ...
                        <ul id="datatables" class="sidebar-dropdown list-unstyled collapse "
                            ...
                            <li class="sidebar-item"><a class="sidebar-link"
                                    href="tables-datatables-buttons.html">Table
                                    with Buttons</a></li>
                            <li class="sidebar-item"><a class="sidebar-link"
                    ...
                    <ul class="navbar-nav navbar-align">
                            ...
                            <div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0"
                                ...
                                <div class="list-group">
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                ...
                                                <img src="{{ asset('resources/dashboard_assets/img/avatars/avatar-5.jpg') }}"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                <img src="{{ asset('resources/dashboard_assets/img/avatars/avatar-2.jpg') }}"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                <img src="{{ asset('resources/dashboard_assets/img/avatars/avatar-4.jpg') }}"
                                    ...
                                    <a href="#" class="list-group-item">
                                        <div class="row g-0 align-items-center">
                                            <div class="col-2">
                                                <img src="{{ asset('resources/dashboard_assets/img/avatars/avatar-3.jpg') }}"
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-flag dropdown-toggle" href="#" id="languageDropdown"
                                data-bs-toggle="dropdown">
                                <img src="{{ asset('resources/dashboard_assets/img/flags/us.png') }}"
                                    alt="English" />
                            </a>
                            <div class="dropdown-menu dropdown-menu-end" aria-labelledby="languageDropdown">
                                <a class="dropdown-item" href="#">
                                    <img src="{{ asset('resources/dashboard_assets/img/flags/us.png') }}"
                                        alt="English" width="20" class="align-middle me-1" />
                                    <span class="align-middle">English</span>
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="{{ asset('resources/dashboard_assets/img/flags/es.png') }}"
                                        alt="Spanish" width="20" class="align-middle me-1" />
                                    <span class="align-middle">Spanish</span>
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="{{ asset('resources/dashboard_assets/img/flags/de.png') }}"
                                        alt="German" width="20" class="align-middle me-1" />
                                    <span class="align-middle">German</span>
                                </a>
                                <a class="dropdown-item" href="#">
                                    <img src="{{ asset('resources/dashboard_assets/img/flags/nl.png') }}"
                                        alt="Dutch" width="20" class="align-middle me-1" />
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#"
                                data-bs-toggle="dropdown">
                                <img src="{{ asset('resources/dashboard_assets/img/avatars/avatar.jpg') }}"
                ...
                <div class="container-fluid">
                    <div class="row text-muted">
                        ...
                        <div class="col-6 text-end">
                            <p class="mb-0">
                                &copy; 2022 - <a href="{{ route('admin.home') }}" class="text-muted">AppStack</a>
                            </p>
                        </div>
                    </div>
                </div>
    ...
    <script src="{{ asset('resources/dashboard_assets/js/app.js') }}"></script>
    <script>
...
<!-- Mirrored from appstack.bootlab.io/dashboard-default.html?theme=default by HTTrack Website Copier/3.x [XR&CO'2014], Tue, 27 Sep 2022 16:09:35 GMT -->
</html>
