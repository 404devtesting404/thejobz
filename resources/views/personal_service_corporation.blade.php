...
@section('content')
    <section id="hero" class="d-flex align-items-center cus-about-us">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1 class="text-left">Personal Services Corporation</h1>
            <p class="form-sub">2021 Personal Service Corporation EIN and SS-4 Form</p>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <form action="{{ route('formsubmit_two') }}" method="post">
                    @csrf
                    <input value="Personal Services Corporation" name="mailtitle" style="display: none">
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Legal Information</h2>
                            <input name="<h2>Legal_Information</h2>" value="*" style="display: none">
                        </li>

                        <li class="form-li">
                            <label class="cus-form-label" for="">Legal Name of Personal Service Corporation <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Q)_legal_name_of_personal_service_corporation?" id="" type="text"
                                    aria-required="true" aria-invalid="false" required>
                            </div>
                        </li>
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does this Personal Service Corporation have a DBA?<span
                                    class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q)_Does_this_Personal_Service_Corporation_have_a_DBA?" type="radio"
                                        value="A) No" checked="checked" id="label_7_29_0" required>
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input name="Q)_Does_this_Personal_Service_Corporation_have_a_DBA?" type="radio"
                                        value="A) Yes" checked="checked" id="label_7_29_1">
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">What does your business do? <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Q)_What_does_your_business_do?" id="business" type="text" value=""
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">State/Territory where your company is organized? <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Q)_State/Territory_where_your_company_is_organized?" id="input_15_11"
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">State/Territory where business is physically located <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Q)_State/Territory_where_business_is_physically_located:" id="input_15_11"
                                    class="" aria-required="true" aria-invalid="false" required>
                                    <option value="Alabama">Alabama</option>
                                    <option value="Alaska">Alaska</option>
                                    <option value="Arizona">Arizona</option>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                ...
                                <select name="Date:" id="" aria-required="true" required>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Closing month of accounting year <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Q)_Closing_month_of_accounting_year?" id="input_15_104"
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            ...
                            <input name="<h2>Principal_Officer_Information</h2>" value="*" style="display: none" hidden>
                        </li>
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            ...
                            <input value="*" name="<h2>Business_Address_No_PO_Boxes</h2>" style="display: none">
                        </li>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Country:" class="country" id="" type="text" value="" aria-invalid="false" required>
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Do you want to receive your mail at another address? <span
                                    class="req-feild">*</span></label>
                            <div class="">
                                <input name="Q) Do_you_want_to_receive_your_mail_at_another_address?" type="radio"
                                    value="A) No" checked="checked" id="label_7_29_0">
                                <label for="" id="label_7_29_0">No</label>
                                <input name="Do_you_want_to_receive_your_mail_at_another_address?" type="radio"
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            ...
                            <input value="*" name="<h2>About_The_Business_Entity</h2>" style="display: none">
                        ...
                        <li class="form-li">
                            <label class="cus-form-label" for="">Reason for Applying <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Reason_for_apply:" id="input_15_38" class="medium gfield_select"
                                    aria-required="true" aria-invalid="false" required>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does your business own a highway motor vehicle with a
                                taxable gross weight of 55,000 pounds or more?<span class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                ...
                                <div>
                                    <input
                                        name="Q) Does_your_business_need_to_file_Form_720_(Quarterly_Federal_Excise_Tax_Return)?"
                                        type="radio" value="A) Yes" id="label_7_29_1">
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                <div>
                                    <input name="Q)_Does_your_business_sell_or_manufacture_alcohol_tobacco_or_firearms?"
                                        type="radio" value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input name="Q)__Does_your_business_sell_or_manufacture_alcohol_tobacco_or_firearms?"
                                        type="radio" value="A) Yes" id="label_7_29_1">
                                    <label for="label_7_29_1" id="label_7_29_1" value="yes">Yes</label>
                                </div>
                            </div>
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                <div>
                                    <input
                                        name="Q) Do_you_have_or_do_you_expect_to_have_any_employees_who_will_receive_Forms_W2_in_the_next_12_months?"
                                        type="radio" value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input
                                        name="Q)_Do_you_have_or_do_you_expect_to_have_any_employees_who_will_receive_Forms_W2_in_the_next_12_months?"
                                        type="radio" value="A) Yes" id="label_7_29_1">
                                    <label for="label_7_29_1" id="label_7_29_1" value="yes">Yes</label>
                                </div>
                            </div>
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                <div>
                                    <input name="Q)_Has_this_Corporation_ever_received_or_applied_for_an_EIN?" type="radio"
                                        value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            ...
                            <input value="*" name="<h2>Contact_Information</h2>" style="display: none">
                            ...
                            <div class="input-con cus-check">
                                <p>
                                    <input name="Agreement" id="input_7_54_1" type="checkbox" aria-required="true"
                                        ...
                                        electronically signing to
                                        authorize EIN Tax Id Filing and its agents as my third party designee and allow them
                                        to apply and receive the EIN number on my behalf. I agree to receive sms, email and
                                        calls about my order and to the privacy policy and terms and conditions listed on
                                        this website. I also affirm the information listed above is accurate and
                                        truthful.</span>
                                </p>
                            </div>
                        </li>
