...
@section('content')
    <div class="content container-fluid">
        ...
        <div class="d-sm-flex align-items-center justify-content-between mb-2">
            <h1 class="h3 mb-0 text-black-50">Problems {{ trans('messages.List') }}</h1>
        </div>
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-header">
                        <h5>Problems {{ trans('messages.table') }}</h5>
                    </div>
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" style="cursor: pointer;"
                                                            href="{{ route('admin.contact.problems_view', $p->id) }}">
                                                            {{ trans('messages.View') }}</a>
                                                        <a class="dropdown-item delete" style="cursor: pointer;"
                                                            id="{{ $p['id'] }}"> {{ trans('messages.Delete') }}</a>
                                                    </div>
                                                </div>
                                            </td>
                                        </tr>
        ...
        $(document).on('click', '.delete', function() {
            ...
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: "{{ route('admin.contact.problems_delete') }}",
                        method: 'POST',
                        data: {
                            id: id
                        },
