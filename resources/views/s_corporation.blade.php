...
@section('content')
    <section id="hero" class="d-flex align-items-center cus-about-us">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1 class="text-left">S-Corporation</h1>
            <p class="form-sub">2021 S-Corporation EIN and SS-4 Form</p>
        </div>
    </section><!-- End Hero -->
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <form action="{{ route('formsubmit_two') }}" method="post">
                    @csrf
                    <input value="S-Corporation" name="mailtitle" style="display: none">

                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">S-Corporation Information</h2>
                        </li>
                        <input name="<h2>S-Corporation Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">Legal Name of the S-Corporation <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Legal Name of the S-Corporation" id="" type="text" value=""
                                    aria-required="true" aria-invalid="false" required>
                            </div>
                        </li>
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does this S-Corporation have a DBA? <span
                                    class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Does this S-Corporation have a DBA?" type="radio" value="A) No"
                                        checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input name="Q) Does this S-Corporation have a DBA?" type="radio" value="A) Yes"
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">What does your business do? <span
                                    class="req-feild">*</span></label>
                            <div class="Q) What does your business do?">
                                <input name="" id="" type="text" value="" aria-invalid="false" required>
                            </div>
                        </li>

                        <li class="form-li">
                            <label for="" class="cus-form-label">State/Territory where your company is organized? <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Q) State/Territory where your company is organized?" id="input_15_11"
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">State/Territory where business is physically located <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="State/Territory where business is physically located:" id="input_15_11"
                                    class="" aria-required="true" aria-invalid="false" required>
                                    <option value="Alabama">Alabama</option>
                                    <option value="Alaska">Alaska</option>
                                    <option value="Arizona">Arizona</option>
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Principal Officer Information</h2>
                        </li>
                        <input name="<h2>Principal Officer Information</h2>" value="*" style="display: none">
                        <li class="form-li">
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <input name="<h2>Business Address (No PO Boxes)</h2>" value="*" style="display: none">
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <input name="<h2>About The Business Entity</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">Reason for Applying <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Reason for Applying:" id="input_15_38" class="medium gfield_select"
                                    aria-required="true" aria-invalid="false" required>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Has this Corporation ever received or applied for an EIN
                                before? <span class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Has this Corporation ever received or applied for an EIN before?"
                                        type="radio" value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
