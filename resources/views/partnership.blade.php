...
@section('content')
    <section id="hero" class="d-flex align-items-center cus-about-us">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1 class="text-left">Partnership</h1>
            <p class="form-sub">2021 Partnership EIN and SS-4 Form</p>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <form action="{{ route('formsubmit_two') }}" method="post">
                    @csrf
                    <input value="Partnership" name="mailtitle" style="display: none">

                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Partnership Information</h2>
                        </li>
                        <input name="<h2>Partnership Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">Legal Name of Partnership <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Legal Name of Partnership:" required id="" type="text" value=""
                                    aria-required="true" aria-invalid="false">
                            </div>
                        </li>
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does this Partnership have a DBA? <span
                                    class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Does this Partnership have a DBA?" type="radio" value="A) No"
                                        checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input name="Q) Does this Partnership have a DBA?" type="radio" value="A) Yes"
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">What does your business do? <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="What does your business do?" id="" type="text" value="" aria-invalid="false"
                                    required>
                            </div>
                        </li>
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Primary Partner Information</h2>
                        </li>
                        <input name="<h2>Primary Partner Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">First Name <span class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="First Name:" class="first_name" id="" type="text" value="" aria-required="true"
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Middle Name:" class="middle_name" id="" type="text" value="" aria-invalid="false">
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Last Name:" class="last_name" required id="" type="text" value="" aria-invalid="false">
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Social Security # <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Social Security #:" class="social_security" id="" type="text" value="" aria-invalid="false" required>
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Confirm Social Security # <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Confirm Social Security #:" class="confirm_social_security" id="" type="text" value="" aria-invalid="false"
                                    required>
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <li class="form-li">
                            <label class="cus-form-label" for="">Recipient Email <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Recipient Email:" id="" class="email" type="email" value="" aria-required="true"
                                    aria-invalid="false" required>
                                <span>Enter Email</span>
                                <input name="Confirm Email:" required id="" class="confirm_email" type="email" value="" aria-required="true"
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Recipient Phone Number <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Recipient Phone Number:" class="recipient_phone_number" required id="" type="text" value=""
                                    aria-invalid="false">
                            </div>
                        </li>
