...
@section('content')
    <section id="hero" class="d-flex align-items-center cus-about-us">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1 class="text-left">Trust</h1>
            <p class="form-sub">2021 Trust EIN and SS-4 Form</p>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <form action="{{ route('formsubmit_two') }}" method="post">
                    @csrf
                    <input value="Trust" name="mailtitle" style="display: none">
                    <!-- .........................Legal Information............................... -->
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Legal Information</h2>
                        </li>
                        <input name="<h2>Legal Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">Trust Name <span class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Trust Name:"  id="" type="text" value=""
                                    aria-required="true" aria-invalid="false" required>
                            </div>
                        </li>

                        <li class="form-li">
                            <label for="" class="cus-form-label">Type of Trust <span class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Type of Trust:" id="input_12_113" class="medium gfield_select"
                                    aria-required="true" aria-invalid="false" required>
                                    <option value="" class="gf_placeholder">Select one</option>
                                    <option value="Bankruptcy Estate (Individual)">Bankruptcy Estate (Individual)</option>
                                    ...
                                    <option value="Charitable Remainder Annuity Trust">Charitable Remainder Annuity Trust
                                    </option>
                                    ...
                                    <option value="FNMA (Fannie Mae)">FNMA (Fannie Mae)</option>
                                    <option value="GNMA (Ginnie Mae)">GNMA (Ginnie Mae)</option>
                                    ...
                                    <option value="Trust (All Others)">Trust (All Others)</option>
                                </select>
                            </div>
                        </li>

                        <li class="form-li">
                            <label for="" class="cus-form-label">Has this Trust ever received or applied for an EIN before?
                                <span class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Has this Trust ever received or applied for an EIN before?" type="radio"
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Do you currently have, or plan to hire employees within the
                                next year (not including owners)? <span class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input
                                        name="Q) Do you currently have, or plan to hire employees within the next year (not including owners)?"
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Creator/Grantor Information</h2>
                        </li>
                        <input name="<h2>Creator/Grantor Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">First Name <span class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="First Name:" class="first_name" id="" type="text" value=""
                                    aria-required="true" aria-invalid="false" required>
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Last Name:" class="last_name" id="" type="text" value=""
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Social Security #:" class="social_security" id="" type="text" value=""
                                    aria-invalid="false" required>
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Confirm Social Security # <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Confirm Social Security #:" class="confirm_social_security" id="" type="text"
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Trustee Information</h2>
                        </li>
                        <input name="<h2>Trustee Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">Trustee First Name <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Trustee First Name:" class="first_name" id="" type="text" value="" aria-required="true"
                                    aria-invalid="false" required>
                            </div>
                        </li>
                        <li class="form-li">
                            <label class="cus-form-label" for="">Trustee Middle Name</label>
                            <div class="input-con">
                                <input name="Trustee Middle Name:" class="middle_name" id="" type="text" value=""
                                    aria-required="true" aria-invalid="false">
                            </div>
                        </li>
                        <li class="form-li">
                            <label class="cus-form-label" for="">Trustee Last Name <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Trustee Last Name:" class="last_name" id="" type="text" value=""
                                    aria-required="true" aria-invalid="false" required>
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <select name="Title:" id="input_12_118" class="medium gfield_select" aria-required="true"
                                    aria-invalid="false" required>
                    ...
                    <!-- .........................Trustee Address (No PO Boxes)............................... -->
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Trustee Address (No PO Boxes)</h2>
                        </li>
                        <input name="<h2>Trustee Address (No PO Boxes)</h2>" value="*" style="display: none">
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Address:" id="" type="text" value="" aria-required="true" aria-invalid="false"
                                    required>
                                <span> Address </span>
                                <input class="space-top" name="Address 2" id="" type="text" value=""
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Country:" class="country" id="" type="text" value=""
                                    aria-invalid="false" required>
                            </div>
                        </li>
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Dates</h2>
                        </li>
                        <input name="<h2>Dates</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">Date the Trust was started or acquired <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Date the Trust was started or acquired:" aria-required="true" required>
                        ...
                        <li class="form-li">
                            <label class="cus-form-label" for="">Closing month of accounting year <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Closing month of accounting year:" id="input_12_104"
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <li class="form-li">
                            <label class="cus-form-label" for="">Recipient Email <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Recipient Email:" id="" class="email" type="email" value=""
                                    aria-required="true" aria-invalid="false" required>
                                <span>Enter Email</span>
                                <input name="Confirm Email:" id="" required class="confirm_email" type="email" value=""
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Recipient Phone Number <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Recipient Phone Number" class="recipient_phone_number" id="" type="text"
                                    value="" aria-invalid="false" required>
                            </div>
                        </li>
