...
@section('content')
    <section id="hero" class="d-flex align-items-center cus-about-us">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1 class="text-left">C-Corporation</h1>
            <p class="form-sub">2021 C-Corporation EIN and SS-4 Form</p>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <form action="{{ route('formsubmit_two') }}" method="post">
                    @csrf
                    <input value="C-Corporation" name="mailtitle" style="display: none">

                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">C-Corporation Information</h2>
                        </li>
                        <input name="<h2>C-Corporation Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">Legal Name of the Corporation <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Legal Name of the Corporation:" id="" type="text" value="" aria-required="true"
                                    aria-invalid="false" required>
                            </div>
                        </li>
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does this Corporation have a DBA? <span
                                    class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Does this Corporation have a DBA?" type="radio" value="A) No"
                                        checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input name="Q) Does this Corporation have a DBA?" type="radio" value="A) Yes"
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">What does your business do? <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Q) What does your business do?" id="" type="text" value="" aria-invalid="false"
                                    required>
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">State/Territory where business is physically located? <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Q) State/Territory where business is physically located?" id="input_15_11"
                                    class="" aria-required="true" aria-invalid="false" required>
                                    <option value="Alabama">Alabama</option>
                                    <option value="Alaska">Alaska</option>
                                    <option value="Arizona">Arizona</option>
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="First Name:" id="" class="first_name" type="text" value=""
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Middle Name:" id="" class="middle_name" type="text" value=""
                                    aria-invalid="false">
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Last Name:" id="" class="last_name" type="text" value=""
                                    aria-invalid="false" required>
                            </div>
                        </li>
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <li class="form-li">
                            <label class="cus-form-label" for="">Primary Activity <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Primary Activity:" id="input_15_39" class="medium gfield_select"
                                    aria-required="true" aria-invalid="false" required>
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <li class="form-li">
                            <label class="cus-form-label" for="">Recipient Email <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Recipient Email:" class="email" id="" type="email" value=""
                                    aria-required="true" required aria-invalid="false">
                                <span>Enter Email</span>
                                <input name="Confirm Email:" required id="" class="confirm_email" type="email" value=""
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Recipient Phone Number <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Recipient Phone Number:" class="recipient_phone_number" id="" type="text" value="" required
                                    aria-invalid="false">
                            </div>
                        </li>
