                    ...
                    <div class="card-body">
                        <form method="POST" action="{{ route('register') }}">
                            ...
                            <div class="form-group mb-4">
                                <label class="emaillabel" for="name">{{ __('Name') }}</label>
                                <input id="name" type="text"
                                    class="form-control thejobz-input email @error('name') is-invalid @enderror"
                            ...
                            <div class="form-group mb-4">
                                <label class="passwordlabel" for="password-confirm">{{ __('Confirm Password') }}</label>
                                <input id="password-confirm" type="password" class="form-control thejobz-input password"
                                    name="password_confirmation" required autocomplete="new-password"
                                    placeholder="Confirm your password">
                            </div>

                            <div class="form-group mb-4">
                                <button type="submit" class="btn thejobz-btn w-100" id="registerButton">
                                    {{ __('Register') }}
                                </button>
                            </div>
                            ...
                            <div class="text-center pt-3">
                                <p class="mb-0">Already have an account?
                                    <a href="{{ route('login') }}" class="thejobz-link font-weight-bold">
                                        Login Here
                                    </a>
                                </p>
                            </div>
