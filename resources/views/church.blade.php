...
@section('content')
    <section id="hero" class="d-flex align-items-center cus-about-us">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1 class="text-left">Church</h1>
            <p class="form-sub">2021 Church Organization EIN and SS-4 Form</p>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <form action="{{ route('formsubmit_two') }}" method="post">
                    @csrf
                    <input value="Church" name="mailtitle" style="display: none">
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Church Organization</h2>
                        </li>
                        <input name="<h2>Church Organization</h2>" value="*" style="display: none">
                        <li class="form-li">
                            <label class="cus-form-label" for="">Legal Name of the Church <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Legal Name of the Church:" required id="" type="text" value=""
                                    aria-required="true" aria-invalid="false" required>
                            </div>
                        </li>
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does this Church have a DBA? <span
                                    class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Does this Church have a DBA?" type="radio" value="A) No"
                                        checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input name="Q) Does this Church have a DBA?" type="radio" value="A) Yes"
                                        checked="checked" id="label_7_29_1">
                        ...
                        <!-- <li  class="form-li">
                                                            <label  for="" class="cus-form-label">What does your business do?</label>
                                                            <div class="input-con">
                                                                <input name="" id="" type="text" value=""  aria-invalid="false">
                                                            </div>
                                                        </li> -->

                        <li class="form-li">
                            <label for="" class="cus-form-label">State/Territory where the Church was organized? <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Q) State/Territory where the Church was organized?" id="input_15_11"
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">State/Territory where Church is physically located <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="State/Territory where Church is physically located:" id="input_15_11"
                                    class="" aria-required="true" aria-invalid="false" required>
                                    <option value="Alabama">Alabama</option>
                                    <option value="Alaska">Alaska</option>
                                    <option value="Arizona">Arizona</option>
                        ...
                        <li class="form-li">
                            <label class="cus-form-label" for="">Date entity was started or acquired <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Date entity was started or acquired:" aria-required="true" required>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Closing month of accounting year <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Closing month of accounting year:" id="input_15_104"
                                    class="medium gfield_select" aria-required="true" aria-invalid="false" required>
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <input name="<h2>Responsible Party Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">First Name <span class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="First Name:" class="first_name" required id="" type="text" value=""
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Middle Name:" class="middle_name" id="" type="text" value=""
                                    aria-invalid="false">
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Last Name:" class="last_name" required id="" type="text" value=""
                                    aria-invalid="false">
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <select name="Title:" required id="" class="cus-form-select" aria-required="true"
                                    aria-invalid="false">
                                    <option value="">Select one</option>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Social Security # <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Social Security #:" class="social_security" required id="" type="text" value=""
                                    aria-invalid="false">
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Confirm Social Security # <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Confirm Social Security #:" class="confirm_social_security" required id=""
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Corporate Address (No PO Boxes)</h2>
                        </li>
                        <input name="<h2>Corporate Address (No PO Boxes)</h2>" value="*" style="display: none">
                        <li class="form-li">
                            <label class="cus-form-label" for="">Address <span class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Address" required id="" type="text" value="" aria-required="true"
                                    aria-invalid="false">
                                <span> Address </span>
                                <input class="space-top" name="Address2:" id="" type="text" value=""
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <input name="Country:" class="country" required id="" type="text" value=""
                                    aria-invalid="false">
                            </div>
                        </li>
                    ...
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">About The Church Organization</h2>
                        </li>
                        <input name="<h2>About The Church Organization</h2>" value="*" style="display: none">
                        <li class="form-li">
                            <label class="cus-form-label" for="">Reason for Applying <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Reason for Applying:" required id="input_15_38" class="medium gfield_select"
                                    aria-required="true" aria-invalid="false">
                        ...
                        <li class="form-li">
                            <label class="cus-form-label" for="">Primary Activity <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <select name="Primary Activity:" required id="input_15_39" class="medium gfield_select"
                                    aria-required="true" aria-invalid="false">
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                <div>
                                    <input
                                        name="Q) Does your business own a highway motor vehicle with a taxable gross weight of 55,000 pounds or more?"
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Does your business involve gambling/wagering?" type="radio"
                                        value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                <div>
                                    <input
                                        name="Q) Does your business need to file Form 720 (Quarterly Federal Excise Tax Return)?"
                                        type="radio" value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Does your business sell or manufacture alcohol, tobacco, or firearms?"
                                        type="radio" value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                        ...
                        <li class="form-li">
                            ...
                            <div class="full-radio">
                                <div>
                                    <input
                                        name="Q) Do you have, or do you expect to have, any employees who will receive Forms W-2 in the next 12 months?"
                                        type="radio" value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input
                                        name="Q) Do you have, or do you expect to have, any employees who will receive Forms W-2 in the next 12 months?"
                                        type="radio" value="yes" id="label_7_29_1">
                                    <label for="label_7_29_1" id="label_7_29_1" value="A) Yes">Yes</label>
                                </div>
                            </div>
                        </li>

                        <li class="form-li">
                            <label for="" class="cus-form-label">Has this Church ever received or applied for an EIN
                                before? <span class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q) Has this Church ever received or applied for an EIN before?"
                                        type="radio" value="A) No" checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <input name="<h2>Contact Information</h2>" value="*" style="display: none">

                        <li class="form-li">
                            <label class="cus-form-label" for="">Recipient Email <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Recipient Email:" class="email" required id="" type="email" value=""
                                    aria-required="true" aria-invalid="false">
                                <span>Enter Email</span>
                                <input name="Confirm Email:" class="confirm_email" required id="" type="email" value=""
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Recipient Phone Number <span
                                    class="req-feild">*</span></label>
                            <div class="input-con">
                                <input name="Recipient Phone Number:" class="recipient_phone_number" required id=""
                                    type="text" value="" aria-invalid="false">
                            </div>
                        </li>
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con cus-check">
                                <p>
                                    <input name="Agreement" required id="input_7_54_1" type="checkbox" aria-required="true"
                                        aria-invalid="false"> <span>By checking this box, I am
