...
@section('content')
    <section id="hero" class="d-flex align-items-center cus-about-us">
        <div class="container" data-aos="zoom-out" data-aos-delay="100">
            <h1 class="text-left">Sole Proprietorship</h1>
            <p class="form-sub">2021 Sole Proprietor / Individual EIN and SS-4 Form</p>
        ...
        <div class="container">
            <div class="col-md-12">
                ...
                <form action="{{ route('formsubmit_two') }}" method="post">
                    @csrf
                    <input value="Sole Proprietorship" name="mailtitle" style="display: none">
                    <!-- .........................Owner Information............................... -->
                    <ul class="cus-formcontainer">
                        <li class="cus-form-hd">
                            <h2 class="gsection_title">Owner Information</h2>
                        </li>
                        <input name="<h2>Owner Information</h2>" value="*" style="display: none">
                        <li class="form-li">
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Do you want to receive your mail at another address? <span
                                    class="req-feild">*</span></label>
                            <div class="">
                                <input name="Q)_Do you want to receive your mail at another address?" type="radio"
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does this business have a DBA? <span
                                    class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input name="Q)_Does_this_business_have_a_DBA?" type="radio" value="A) No"
                                        checked="checked" id="label_7_29_0">
                                    <label for="label_7_29_0" id="label_7_29_0">No</label>
                                </div>
                                <div>
                                    <input name="Q)_Does_this_business_have_a_DBA?" type="radio" value="A) Yes"
                                        id="label_7_29_1">
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con">
                                <select name="Reason for Applying: " id="input_15_38" class="medium gfield_select"
                                    ...
                                    <option value="Started a New Business" selected="selected">Started a New Business
                                    </option>
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does your business need to file Form 720 (Quarterly Federal
                                Excise Tax Return)? <span class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                                    <input
                        ...
                        <li class="form-li">
                            <label for="" class="cus-form-label">Does your business sell or manufacture alcohol, tobacco, or
                                firearms? <span class="req-feild">*</span></label>
                            <div class="full-radio">
                                <div>
                    ...
                    <ul class="cus-formcontainer">
                        ...
                        <li class="form-li">
                            ...
                            <div class="input-con cus-check">
                                <p>
                                    <input name="Agreement" id="input_7_54_1" type="checkbox" value="1" aria-required="true"
